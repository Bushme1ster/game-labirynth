...
win_width = 700
win_height = 500
display.set_caption('Лабиринт от меня')
window = display.set_mode((win_width, win_height))
back = (3, 177, 252)#задаем цвет согласно цветовой схеме RGB
...
barriers.add(w2)
#создаем спрайты
packman = Player('crazy_frog-removebg-preview.png', 5, win_height - 80, 80, 80, 0, 0)
monster1 = Enemy('enemy_monster-removebg-preview.png', win_width -80, 130, 80, 80, 7)
monster2 = Enemy('enemy_monster2-removebg-preview.png', win_width -80, 250, 80, 80, 7)
final_sprite = GameSprite('money_bag-removebg-preview.png', win_width-85, win_height-100, 80, 80)
